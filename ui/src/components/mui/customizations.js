...
import {ListItem, ListItemText, styled, Switch, TextField, Typography} from "@mui/material";

export const MuiIcon = ( {Component, ...props}) => (
    <Component style={{verticalAlign: 'middle'}} {...props}/>
);
...
export const ExampleSwitch = styled(Switch)(({ theme }) => ({
    ...
    '& .MuiSwitch-switchBase': {
        ...
        '&.Mui-checked': {
            ...
            '& + .MuiSwitch-track': {
                // opacity: 1,
                backgroundColor: '#F8D018' //theme.palette.mode === 'dark' ? '#8796A5' : '#aab4be',
            },
        },
    },
    // '& .MuiSwitch-thumb': {
